...
class Goal(models.Model):
    ...
    icon = models.CharField(max_length=10, default='\U0001F3AF')
...
class SIPLog(models.Model):
    ...
    NOTE: `month` is 0-indexed (0=Jan to 11=Dec) to mirror JS Date.getMonth().
...
class DailyTrackerEntry(models.Model):
    ...
    date = models.DateField(db_index=True)  # frequently filtered on list queries
